# Gestiona la carga y guardado de los puntajes más altos de los usuarios.
import json
import os
...
def load_high_scores() -> list[dict]:
    # Carga los puntajes más altos desde el archivo JSON.
...
def is_high_score(score: int, scores: list[dict]) -> bool:
    # Verifica si un puntaje califica para estar en la lista de los mejores.
...
def add_high_score(name: str, score: int, scores: list[dict]) -> list[dict]:
    # Añade un nuevo puntaje a la lista, la ordena y la recorta.
